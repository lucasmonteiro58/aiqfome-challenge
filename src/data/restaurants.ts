...
export const restaurants: Restaurant[] = [
            ...
            customizations: [
              {
                ...
                options: [
                  ...
                  { id: "teriyaki", label: "Molho Teriyaki", price: 1 },
                  {
                    id: "sem-molho",
                    label: "Sem molho",
                    price: 0,
              ...
              },
              {
                ...
                options: [
                  ...
                  { id: "sunomono", label: "Sunomono", price: 2 },
                ],
              },
              {
                id: "talher",
            ...
            customizations: [
              {
                ...
                options: [
                  { id: "shoyu", label: "Shoyu", price: 0 },
                  { id: "picante", label: "Molho picante", price: 1 },
                  {
                    id: "sem-molho",
                    label: "Sem molho",
                    price: 0,
              ...
              },
              {
                ...
                options: [
                  { id: "wasabi", label: "Wasabi", price: 0 },
                  { id: "gengibre", label: "Gengibre", price: 0 },
                  { id: "salada", label: "Salada de pepino", price: 2 },
                ],
              },
              {
                id: "talher",
            ...
            customizations: [
              {
                ...
                required: false,
                options: [
                  { id: "shoyu-doce", label: "Shoyu doce", price: 0 },
                  {
                    id: "sem-molho",
                    label: "Sem molho",
                    price: 0,
            ...
            customizations: [
              {
                ...
                options: [
                  ...
                  { id: "grande", label: "Grande", price: 4 },
                ],
              },
              {
                id: "adicionais",
                ...
                required: false,
                options: [
                  { id: "cream-cheese", label: "Cream cheese extra", price: 2 },
                  { id: "shimeji", label: "Shimeji", price: 3 },
                  { id: "cebolinha", label: "Cebolinha", price: 1 },
                ],
              },
              {
                id: "talher",
          ...
          },
          {
            ...
            customizations: [
              ...
              },
              {
                ...
                options: [
                  { id: "cream-cheese", label: "Cream cheese extra", price: 2 },
                  { id: "cebolinha", label: "Cebolinha extra", price: 1 },
                ],
              },
            ],
          },
            ...
            customizations: [
              {
                ...
                max: 3,
                options: [
                  { id: "shimeji", label: "Shimeji", price: 0 },
                  { id: "alface", label: "Alface americana", price: 0 },
                  { id: "rucula", label: "Rúcula", price: 0 },
                  { id: "pepino", label: "Pepino", price: 0 },
                  { id: "tomate", label: "Tomate seco", price: 0 },
            ...
            customizations: [
              {
                ...
                required: true,
                options: [
                  { id: "leve", label: "Leve", price: 0, default: true },
                  { id: "medio", label: "Médio", price: 0 },
                  { id: "forte", label: "Forte", price: 0 },
                ],
              },
              {
                id: "tamanho",
        ...
        products: [
          {
            ...
            customizations: [
              ...
              },
              {
                ...
                options: [
                  { id: "mal-passado", label: "Mal passado", price: 0 },
                  {
                    id: "ao-ponto",
                    label: "Ao ponto",
                    price: 0,
                  ...
                  { id: "bem-passado", label: "Bem passado", price: 0 },
                ],
              },
              {
                type: "multiple",
                ...
                options: [
                  ...
                  { id: "cheddar", label: "Cheddar extra", price: 2 },
                  {
                    id: "cebola-crocante",
                    label: "Cebola crocante",
                    price: 1.5,
                  },
                ],
              },
              {
                ...
                id: "molho-extra",
                required: false,
                title: "Adicionar molho extra?",
                options: [
                  { id: "maionese", label: "Maionese extra", price: 1 },
                  { id: "ketchup", label: "Ketchup extra", price: 0.5 },
                  { id: "barbecue", label: "Barbecue", price: 1 },
                ],
              },
              {
                type: "single",
                ...
                options: [
                  { id: "integral", label: "Pão integral", price: 1 },
                  { id: "sem-pao", label: "Sem pão (low carb)", price: 0 },
                  {
                    id: "pao-original",
                    label: "Pão original",
                    price: 0,
            ...
            customizations: [
              ...
              },
              {
                ...
                options: [
                  { id: "cheddar", label: "Cheddar extra", price: 2 },
                  { id: "bacon", label: "Bacon", price: 3 },
                  { id: "salada", label: "Adicionar salada", price: 1.5 },
                ],
              },
              {
                type: "single",
                id: "molho",
                required: false,
                title: "Molho adicional?",
                options: [
                  { id: "maionese", label: "Maionese", price: 1 },
                  { id: "barbecue", label: "Barbecue", price: 1 },
                  {
                    id: "sem-molho",
                    label: "Sem molho",
    ...
    categories: [
      {
        ...
        products: [
            ...
            customizations: [
              {
                ...
                id: "tamanho",
                required: true,
                title: "Tamanho do sanduíche",
                options: [
                  { id: "15cm", label: "15cm", price: 0, default: true },
                  { id: "30cm", label: "30cm", price: 12 },
                ],
              },
              {
                type: "single",
                ...
                options: [
                  ...
                  { id: "parmesao", label: "Parmesão e orégano", price: 0 },
                  { id: "3-queijos", label: "3 queijos", price: 0 },
                ],
              },
              {
                type: "multiple",
                ...
                options: [
                  ...
                  { id: "pepino", label: "Pepino", price: 0 },
                  { id: "azeitona", label: "Azeitona", price: 0 },
                  { id: "rúcula", label: "Rúcula", price: 0 },
                ],
              },
              {
                type: "single",
                ...
                title: "Deseja queijo?",
                options: [
                  { id: "prato", label: "Queijo prato", price: 2 },
              ...
              },
              {
                ...
                options: [
                  { id: "bacon", label: "Bacon", price: 3 },
                  { id: "ovo", label: "Ovo cozido", price: 2 },
                  { id: "pepperoni", label: "Pepperoni", price: 3 },
                ],
              },
              {
                type: "single",
          ...
          {
            id: "frango-defumado-barbecue",
            name: "Frango Defumado com Barbecue",
            description:
              "Frango defumado e suculento com molho barbecue e vegetais frescos",
            image: "/images/products/frango-teriyaki.png",
            basePrice: 19.9,
            price: 12.9,
            hasPromotions: true,
            ...
            customizations: [
              ...
              },
              {
                ...
                options: [
                  ...
                  { id: "cebola", label: "Cebola", price: 0 },
                  { id: "picles", label: "Picles", price: 0 },
                  { id: "milho", label: "Milho", price: 0 },
                  { id: "cenoura", label: "Cenoura ralada", price: 0 },
                ],
              },
              {
                type: "single",
              ...
              },
              {
                ...
                max: 2,
                options: [
                  { id: "bacon", label: "Bacon crocante", price: 3 },
                  { id: "ovo", label: "Ovo cozido", price: 2 },
                  { id: "queijo-extra", label: "Queijo extra", price: 2 },
                ],
              },
              {
                type: "single",
                ...
                options: [
                  ...
                  { id: "mostarda-mel", label: "Mostarda e mel", price: 0 },
                  { id: "maionese", label: "Maionese", price: 0 },
            ...
            customizations: [
              {
                ...
                options: [
                  ...
                  { id: "combo", label: "Combo com batata e refri", price: 12 },
                ],
              },
              {
                type: "multiple",
                ...
                max: 3,
                options: [
                  { id: "bacon", label: "Bacon crocante", price: 4 },
                  { id: "ovo", label: "Ovo frito", price: 3 },
                  {
                    id: "molho-extra",
                    label: "Molho especial extra",
                    price: 1,
                  },
                ],
              },
              {
                ...
                required: false,
                options: [
                  { id: "sim", label: "Garfo e faca descartável", price: 0 },
            ...
            customizations: [
              {
                ...
                title: "Quer em combo?",
                options: [
                  { id: "nao", label: "Só o lanche", price: 0, default: true },
                  { id: "combo", label: "Combo com batata e refri", price: 11 },
                ],
              },
              {
                type: "multiple",
  ...
  {
    id: "5",
    name: "McDonald’s – Shopping Vitória",
    identifier: "mcdonalds-shopping-vitoria",
    logo: "/images/mcdonalds.png",
    deliveryType: "in-store-bag",
    deliveryFee: 6,
    deliveryEstimate: "20-30 min",
    distanceKm: 4.2,
    rating: 4.6,
            ...
            customizations: [
              {
                ...
                title: "Adicionais",
                options: [
                  { id: "chocolate", label: "Calda de chocolate", price: 2 },
                  { id: "caramelo", label: "Calda de caramelo", price: 2 },
                ],
              },
            ],
          },
  ...
  {
    id: "6",
    name: "Subway – Shopping Central",
    identifier: "subway-shopping-central",
    logo: "/images/subway.png",
    deliveryFee: 5,
    deliveryEstimate: "25-35 min",
    deliveryType: "aiqentrega-teal",
    ...
    rating: 4.4,
    openingTime: "2025-05-06T11:00:00.000Z",
    closingTime: "2025-05-06T21:00:00.000Z",
    freeDeliveryThreshold: 35,
    minOrder: 18,
    isOpen: false,
    categories: [
      {
        ...
        products: [
          ...
          },
          {
            id: "veggie-delight",
            name: "Veggie Delight",
            description: "Sanduíche vegetariano com vegetais e molho à escolha",
            image: "/images/products/frango-teriyaki.png",
            basePrice: 18.0,
            price: 18.0,
            hasPromotions: false,
            ...
            customizations: [
              ...
              },
              {
                ...
                options: [
                  { id: "barbecue", label: "Barbecue", price: 0 },
                  { id: "ceasar", label: "Ceasar", price: 0 },
                ],
              },
            ],
          },
  ...
  {
    id: "7",
    name: "McDonald’s – Shopping Leste",
    identifier: "mcdonalds-shopping-leste",
    logo: "/images/mcdonalds.png",
    deliveryType: "motorcycle",
    deliveryFee: 7,
    deliveryEstimate: "25-35 min",
    ...
    rating: 4.6,
    openingTime: "2025-05-06T10:00:00.000Z",
    closingTime: "2025-05-06T20:00:00.000Z",
    freeDeliveryThreshold: 35,
    minOrder: 22,
    isOpen: false,
    categories: [
